...
var ignoredClasses = ["monaco", "[type=search]", "[role=combobox]", "[name=q]"]; // Default ignored classes for input/textarea elements
...
var isTextField = function (elem) {
	...
	if (!elem.isContentEditable && tagName !== "TEXTAREA" && tagName !== "INPUT")
		return false;
